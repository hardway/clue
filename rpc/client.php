...
class Client{
	...
	function __call($name, $arguments){
		...
		if($this->cache_dir){
            ...
            if($this->debug) error_log("[RPC] Checking Cache: $cache_file");

			if(is_file($cache_file) && time()-filemtime($cache_file)<$this->cache_ttl){
                if($this->debug) error_log("[RPC] Using Cache: $cache_file");
...
redirect:
		...
		if($this->cache_dir){
            if($this->debug) error_log("[RPC] Writing Cache: $cache_file");
